...
class FilterUcfList
  ...
  # Print the special character _ID's into the output directory
  def filter_id
  ...
  # Retrieve the column/field attribute where like 'name'
  ...
  # If there is no output directory, then set the default
  ...
  # Merged all ucf files into single file in the output directory
