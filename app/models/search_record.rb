...
class SearchRecord
  ...
  def populate_search_names
    ...
    transcript_names.each do |name_hash|
      ...
      # puts "[DEBUG] Processing name_hash: #{name_hash.inspect}"
      ...
      # puts "[DEBUG] person_gender resolved to #{person_gender.inspect}"
      ...
      if name
        ...
        # puts "[DEBUG] Added search_name: #{name.inspect}"
      end
  ...
  def clean_name(transcript_name)
    ...
    cleaned.squeeze(' ').strip  # remove extra spaces
  end
